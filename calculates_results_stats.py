...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_label_matches'] = 0 #num of matches b/w pet & classifier labels
    results_stats_dic['pct_correct_dogs'] = 0
    results_stats_dic['pct_correct_breed'] = 0
    results_stats_dic['pct_correct_notdogs'] = 0
    results_stats_dic['pct_label_matches'] = 0
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1 and results_dic[key][3] == 1: #pet and class img match + pet imag is a dog
            results_stats_dic['n_correct_breed'] += 1        
        # Pet Image Label is a Dog - counts number of dog images
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            if results_dic[key][4] == 1: #classifies image as Dog (& pet image is a dog) not having the right indentation caused miscalc
    ...
    results_stats_dic['pct_label_matches'] = (results_stats_dic['n_label_matches']/results_stats_dic['n_images']) * 100
